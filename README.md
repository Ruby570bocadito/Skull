...
While this is a security tool, contributions are welcome:
...
This tool is provided "AS IS" without warranty. See [LEGAL.md](LEGAL.md) for full disclaimer.
...
- Consult LEGAL.md for legal questions
...
**Remember: With great power comes great responsibility. Use SKULL-NetRecon wisely and legally!**
